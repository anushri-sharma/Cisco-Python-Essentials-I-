...
* `print(i, "Mississippi")` → prints the number with the word Mississippi.
* `time.sleep(1)` → pauses the program for 1 second each loop.
* After the loop ends, the final message is printed.
